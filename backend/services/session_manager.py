...
class SessionManager:
    ...
    def store_preference(self, session_id: str, key: str, value: Any) -> bool:
        """
        Store a user preference in the session.

        Args:
            session_id: Session identifier
            key: Preference key (e.g., 'ai_model', 'theme')
    ...
    def get_preference(self, session_id: str, key: str) -> Optional[Any]:
        """
        Retrieve a user preference from the session.
    ...
    def remove_preference(self, session_id: str, key: str) -> bool:
        """
