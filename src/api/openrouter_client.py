...
class OpenRouterClient:
    ...
    def validate_api_key(self) -> bool:
        ...
        try:
            ...
            if e.response.status_code == 401:
                return False
            # For other errors, assume key is valid but there was another issue
            return True
        except Exception:
            # For network errors, etc., assume key is valid
            return True
    ...
    def get_usage_stats(self) -> Optional[Dict[str, Any]]:
        ...
        """
        # Note: OpenRouter doesn't provide usage stats via API
        # This would need to be implemented if they add this endpoint
        return None
